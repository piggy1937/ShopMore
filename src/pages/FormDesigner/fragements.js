...
export class PropsEditor extends  PureComponent{
   ...
   */
  renderLengthLimit(){
    const { form:{getFieldDecorator}, definition:{props}, lengthLimit } = this.props;
    ...
    return (
      ...
      >
        <Form.Item label="最小长度" style={{ display: 'inline-block', width: 'calc(50% - 12px)', marginBottom:0 }}>
        ...
        <Form.Item label="最大长度" style={{ display: 'inline-block', width: 'calc(50% - 12px)', marginBottom:0 }}>
