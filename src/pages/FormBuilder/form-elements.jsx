...
import { DatePicker as ReactDatePicker,Select } from 'antd';
      ...
      <div className={baseClasses}>
        ...
        <div className="form-group">
          ...
          <div>
            ...
            { !iOS && !this.props.data.readOnly &&
              <ReactDatePicker onChange={this.onChange} />
            }
          </div>
        </div>
      </div>
...
export {Header,Paragraph,Label,LineBreak,TextInput,NumberInput,TextArea,Dropdown,Image,Checkboxes,DatePicker,RadioButtons,Rating,Tags,Signature,HyperLink,Download,Camera,Range}
